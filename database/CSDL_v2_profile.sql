/* =====================================================================
   CSDL_v2_profile.sql
   Cơ sở dữ liệu MỚI, xây dựng dựa trên CSDL.sql cũ của dự án.
   Toàn bộ bảng/dữ liệu giữ nguyên như bản gốc, chỉ bổ sung:
     - Cột users.updated_at : lưu thời điểm user cập nhật profile gần nhất
       (dùng cho chức năng "Cập nhật thông tin cá nhân" - fullname/phone/images)

   Cách dùng: chạy toàn bộ file này (thay thế CSDL.sql) trên SQL Server
   để tạo lại database từ đầu với schema mới nhất.
   ===================================================================== */
...
INSERT INTO users (email, username, fullname, password, images, phone, roleid, createdate, active)
VALUES
    ('admin@gmail.com',   'admin',   N'Quan Tri Vien',   '123456', NULL, '0900000000', 1, GETDATE(), 1),
    ('manager@gmail.com', 'manager', N'Nguoi Quan Ly',   '123456', NULL, '0900000000', 2, GETDATE(), 1),
    ('mthu@gmail.com',    'mthu',    N'Minh Thu',        '123456', NULL, '0900000000', 3, GETDATE(), 1);
GO
...
/* =====================================================================
   GHI CHÚ: Nếu bạn ĐÃ có sẵn database ShoppingServletDB (không muốn xoá
   dữ liệu cũ), chỉ cần chạy đoạn ALTER dưới đây thay vì cả file trên:
