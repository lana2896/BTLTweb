...
@WebServlet("/cart/unselect")
public class CartUnselectController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            if ("all".equalsIgnoreCase(itemId)) {
                cartService.selectAll(account.getId(), false);
            } else {
                cartService.unselectItem(account.getId(), Integer.parseInt(itemId));
            }
