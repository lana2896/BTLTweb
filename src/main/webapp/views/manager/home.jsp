...
<body>
            ...
            <c:choose>
                <c:when test="${not empty sessionScope.account}">
                    <div class="user-info">
                        ...
                        <a href="logout" class="logout-link" title="Đăng xuất">Thoát</a>
                    </div>
                </c:when>
                <c:otherwise>
    ...
    <c:if test="${not empty sessionScope.user}">
        <div class="welcome-banner">
            Xin chào, <b>${sessionScope.user.fullname}</b>! Rất vui được phục vụ bạn hôm nay.
        </div>
    </c:if>
    ...
    <section class="hero">
        <div class="hero-text">
            ...
            <h1>Trang chủ của Manager<br>Sống xanh mỗi ngày</h1>
        ...
        <div class="product-grid">
            <c:forEach var="i" begin="1" end="4">
                <div class="product-card">
                    ...
                    <div class="product-price">${i}99,000đ</div>
                </div>
            </c:forEach>
        </div>
    </section>
